...
<html>
	<head>
		<title data-page="problem">问题列表</title>
		<meta charset= "utf-8">
	...
	<body>
		<div class="easyui-layout" data-options="fit:true">
		    ...
		    <div data-options="region:'center', border : false" style="background:#eee;">
	    		<!-- searchbar -->
	    		<div id="plSearchIndex">
	    			<form id="searchIndex" class="searchIndex">
						<ul class="searchShow">
							<li class="status">
								<label>状态:</label>
								<select id="repState" class="input_mid" name="problemState" data-options="panelHeight:'auto',editable:false">
							...
							<li>
								<label>申请延期:</label>
								<select id="plDelay" class="input_mid" name="timeBegin">
									<option value="" selected="selected">全部</option>
							...
							<li>
								<label>延期审批:</label>
								<select id="doDelay" class="input_smal" name="timeEnd">
									<option value="" selected="selected">全部</option>
							...
							<li id="repSearch">
								<a id="addSearch" class="easyui-linkbutton" data-options="iconCls:'icon_search',plain:true">查询</a>
							</li> 
						...
						<!-- 	the search conditions to show or hidden -->
						<ul id="searchHide">
							<li>
								<label>是否过期:</label>
								<select id="timeOut" class="input_smal" name="isDelay">
									<option value="" selected="selected">全部</option>
									<option value="1">是</option>
									<option value="0">否</option>
								</select>
							...
							<li>
								<label>有无投诉:</label>
								<select id="isComplain" class="input_smal" name="isComplaint">
									<option value="" selected="selected">全部</option>
							...
							<li>
								<label>投诉处理:</label>
								<select id="doComplain" class="input_smal" name="isDealComplaint">
									<option value="" selected="selected">全部</option>
							...
							<li>
								<label>是否已评价:</label>
								<select id="isComment" class="input_smal" name="isEvaluate">
									<option value="" selected="selected">全部</option>
									<option value="1">是</option>
									<option value="0">否</option>
								</select>
					...
					<!-- the real toolbar of the datagrid -->
					<div >
						<!-- <a id="reDeparctureBtn" class="easyui-linkbutton" data-options="iconCls:'icon_reset',plain:true">重新分派</a>   -->
						<a id="afterRecord" class="easyui-linkbutton" data-options="iconCls:'icon_trackRecord_win8', plain:true">跟踪记录</a> 
						<a id="dealdelay" class="easyui-linkbutton" data-options="iconCls:'shenpiyanqi_win8', plain:true">延期审批</a> 
						<a id="reDeparctureBtn" class="easyui-linkbutton" data-options="iconCls:'icon_tousu', plain:true">投诉处理</a> 
						<!-- <a id="reDeparctureBtn" class="easyui-linkbutton" data-options="iconCls:'hebing_win8', plain:true">合并问题</a>  -->
					</div>	
	    		</div>
				
				<!--     table     -->
			    <table id="proListTable" class="easyui-datagrid" 
			    	data-options="
			    		url : '<%=basePath%>ProblemController/findByCondition',
			    		queryParams : {from : 'problem'},
					    pagination:true,
					    pageSize : 10,
						pageList : [10, 15, 20],
		                fit:true,
		...
		<!--    recordbox      -->
		<jsp:include page="../business/record/recordbox.jsp"></jsp:include>
		
		<!--    the dialog of update password      -->
		...
		<script type="text/javascript" src="<%=basePath%>js/problemlist.js"></script>
